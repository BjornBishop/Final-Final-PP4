...
INSTALLED_APPS = [
    ...
    'bootstrap4', 
    'sagacity.dashboard.apps.DashboardConfig',  # no clue which is the right pathway
    'dashboard.models.Assignment',
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'sagacity', 'templates')],  # updated this path
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
